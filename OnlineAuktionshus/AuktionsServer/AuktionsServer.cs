namespace AuktionsServer {
	...
	public class AuktionsServer {
        ...
        private void GetClient(Socket listener)
        {
            try
            {
                do
                {
                    ...
                    // Tilføj klientsocket til listen over tilsluttede klienter
                    lock (connectedClients)
                    {
                        connectedClients.Add(clientSocket);
                    }
                    BroadcastMessage("Ok");
                    // Start en ny tråd for at håndtere klienten
        ...
        private void BroadcastMessage(string message)
        {
            ...
            // Loop igennem alle tilsluttede klienter og send beskeden
            lock (connectedClients)
            {
        ...
        private Tools.State HandleClientThread(Socket client) {
